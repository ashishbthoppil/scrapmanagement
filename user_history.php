...
<script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
	<head>
		...
		<nav class="navbar navbar-dark navbar-expand-lg" style="position: absolute;right: 10px;top: 140px;">
			<ul class="navbar-nav">
				...
				<li class="nav-item active"><a class="nav-link" href="user_history.php"><strong>History</strong></a></li>
	...
	<body>
		<div class="row">
			<div class="col-12 col-md-4">
				<h3 style="color: floralwhite;"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User History</h3>
			</div>
		</div><br>
		<div class="row">
	...
	$conn = new PDO("mysql:host=$servername;dbname=$dbname", $user, $pass);
				...
				$stmt = $conn->prepare("SELECT * FROM request WHERE username='$userId' ORDER BY createdAt DESC");
...
if(!empty($results)){
	...
	foreach ($results as $result) {
		...
		if($result["status"] == 0){
			...
			$status = "In progress (". $result['employee'] .")";
		}else{
			$status = "Completed";
		}
		$content = "<div class='historyDiv' style='height:auto;'><p><u>Transaction " . $count . "</u><span style='font-size:10px;float:right;'>Created At: ". date("d-M-Y, H:i A", strtotime($result["createdAt"] )) ."</span></p><table class='table table-striped' style='width:100%'><tr><th><u>Items(Qty)</u></th><th><u>Total</u></th><th><u>Status(Assigned Employee)</u></th></tr>";
